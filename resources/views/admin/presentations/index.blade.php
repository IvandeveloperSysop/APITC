            ...
            <div id="accordionFilters" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="selectPromoId" >
                                    <option value="0" selected>Selecciona una presentación valida</option>
                                    @foreach ($presentationSelect as $presentation)
                                        <option value="{{ $presentation->presentationId }}">{{ $presentation->presentationName }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="text-end">
                            <a type="button" class="btn btn-primary" onclick="filterPresentations()">Buscar</a>
                        </div>
                ...
                <div class="card-header">
                    <div class="row justify-content-end">
                        ...
                        <div class="col-md-5 text-end buttonsTable">
                            <a type="button" class="btn text-secondary" data-bs-toggle="modal" data-bs-target="#addPresentation" onclick="getPromoSelect()"><i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                </div>
...
@section('modals')
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example" id="promoId">
                                              </select>
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <label for="addPresentationPoints" class="form-label">Precio en puntos: </label>
                                        <input type="number" class="form-control" id="addPresentationPoints" name="addPresentationPoints" >
    ...
    <div class="modal fade" id="viewDetailsPresentation" tabindex="-1" aria-labelledby="exampleModalPromo" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalPromo">Detalle da la presentación</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            <label for="user" class="form-label">Promociones: </label>
                                            <select class="form-select" aria-label="Default select example" id="promoIdUpdate">
                                            </select>
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <label for="updatePresentationPoints" class="form-label">Precio en puntos: </label>
                                        <input type="number" class="form-control" id="updatePresentationPoints" name="updatePresentationPoints" >
                                        <div id="emailHelp" class="form-text">los puntos no pueden llevar decimales.</div>
                                    </div>
                                </div>
...
@section('js')
   ...
   <script src="{{ asset('js/presentations.js') }}" type="text/javascript"></script>
