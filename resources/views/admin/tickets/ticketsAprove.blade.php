...
@section('content')
    <div class=" mt-4">
        {{-- <a class="btn btn-primary" href="{{ URL::to('/tickets/pdf') }}">Export to PDF</a> --}}
        <h3 class="my-3">Tickets aprobados</h3>
                ...
                <div id="accordionFilters" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="text-end">
                                <a type="button" class="btn btn-primary" onclick="filterTickets(1)">Buscar</a>
                            </div>
...
@section('js')
    ...
    <script src="{{ asset('js/routeGlobal.js') }}"></script>
