...
@section('content')
    <div class=" mt-4">
        <h3 class="my-3">Tickets cancelados</h3>
                ...
                <div id="accordionFilters" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="text-end">
                                <a type="button" class="btn btn-primary" onclick="filterTickets(0)">Buscar</a>
                            </div>
        ...
        <table class="table table-striped">
            ...
            <tbody id="bodyTable">
                ...
                <tr>
                    ...
                    <td style="width: 15vw;" >
                        <a type="button" href="{{route('ticketUpdate',['id'=> $ticket->id, 'view' => 'cancelados'])}}" class="btn btn-success mb-2">Editar</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
