                                                            ...
                                                            <tbody>
                                                               ...
                                                               <tr>
                                                                  <td align="center" class="bmeImage" style="border-collapse: collapse; padding: 10px;">
                                                                     ...
                                                                     <h3 style="color: #a7a8a6;">¡Tú orden ha sido <b style="color: #28B463">confirmada</b>!</h3>
                                                                     <br>
                                                                     <br>
                                                                  </td>
                                                               </tr>
                                                                    ...
                                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                        <tbody>
                                                                           ...
                                                                           <tr>
                                                                              <td align="center" class="bmeImage" style="border-collapse: collapse; padding: 10px;">
                                                                                    {{-- <img src="{{ asset('app/img/back_email.jpg') }}" alt="logoZoom" style="width: 100% !important;"> --}}
                                                                                    <h3 style="color: #5f5f5f;">Nosotros te notificaremos cuando tu pedido esté en camino</h3>
