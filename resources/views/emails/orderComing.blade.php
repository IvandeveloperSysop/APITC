                                                ...
                                                <tr>
                                                   <td width="100%" class="blk_container bmeHolder bmeBody" name="bmeBody" valign="top" align="center" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(255, 255, 255);" bgcolor="#ffffff">
                                                            ...
                                                            <tbody>
                                                               ...
                                                               <tr>
                                                                    <td align="center" class="bmeImage" style="border-collapse: collapse; padding: 10px;">
                                                                        <h2 style="color: #a7a8a6;">Hola {{ $userName }}, <small>000-{{$user_id}}</small></h2>
                                                                        <h3 style="color: #a7a8a6;">
                                                                            ¡Tú orden esta en <b style="color: #3498DB">camino</b>! <br>
                                                                            Favor de estar en el domicilio para recibir tú producto
                                                                        </h3>
                                                                        <br>
                                                                        <img src="{{ asset('img/delivery.jpg') }}" alt="delivery" style="width: 100% !important;">
                                                      ...
                                                      <div id="dv_12" class="blk_wrapper" style="">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: #F3F2F1;">
                                                            <tbody>
                                                               <tr>
                                                                  <td align="center" class="bmeImage" style="border-collapse: collapse;">
                                                                    <span style="widht: 100%;font-size: 30px; font-family: Helvetica, Arial, sans-serif; color: #a7a8a6; line-height: 150%;text-align: center;" >
                                                                        <em><strong>Detalles de la orden</strong></em>
                                                                    </span> <br /> <br />
                                                                  </td>
                                                               </tr>
                                                            </tbody>
                                                            ...
                                                            <tbody>
                                                               <tr>
                                                                  <td class="bmeImageCard" align="center" style="padding-left:10px; padding-right:10px; padding-top:0px; padding-bottom:0px;">
                                                                    ...
                                                                    <table cellspacing="0" cellpadding="0" border="0" class="bmeCaptionTable" style="float: left;" width="720" align="left">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="padding: 60px 11px 30px 11px; font-family: Arial, Helvetica, sans-serif; font-weight: normal; font-size: 14px; color: rgb(56, 56, 56); text-align: left;
                                                                                width:50%" name="tblCell" valign="top" align="left" class="tblCell">
                                                                                    <div style="line-height: 150%;">

                                                                                        <span style="font-size: 18px; font-family: Helvetica, Arial, sans-serif; color: #1e1e1e; line-height: 150%;">
                                                                                            <p style="font-size: 20px;" ><b>Calle: </b> <small>{{ $street }}</small></p>
                                                                                        </span> 
                                                                                        <span style="font-size: 18px; font-family: Helvetica, Arial, sans-serif; color: #1e1e1e; line-height: 150%;">
                                                                                            <p style="font-size: 20px;" ><b>Ciudad: </b>  <small>{{ $city }} years</small></p>
                                                                                        </span> 
                                                                                        <span style="font-size: 18px; font-family: Helvetica, Arial, sans-serif; color: #1e1e1e; line-height: 150%;">
                                                                                            <p style="font-size: 20px;"><b>Municipio:</b>  <small>{{$suburb}}</small></p>
                                                                                        </span>
                                                                                        <span style="font-size: 18px; font-family: Helvetica, Arial, sans-serif; color: #1e1e1e; line-height: 150%;">
                                                                                            <p style="font-size: 20px;"><b>CP:</b> <small>{{$zip}}</small></p>
                                                                                        </span>

                                                                                        @if ($comment)
                                                                                          <span style="font-size: 18px; font-family: Helvetica, Arial, sans-serif; color: #1e1e1e; line-height: 150%;">
                                                                                             <p style="font-size: 20px;"><b>Comentario:</b> <small>{{$comment}}</small></p>
                                                                                          </span>
                                                                                       @endif
                                                                                ...
                                                                                <td style="width: 50%">
                                                                                    ...
                                                                                    <span style="font-size: 18px; font-family: Helvetica, Arial, sans-serif; color: #1e1e1e; line-height: 150%;text-align:justify;">
                                                                                        <img src="{{ $routeGlobal }}{{ $imageProduct }}" alt="{{$productName}}" style="width: 95%;display: block;margin: 0 auto;">
                                                                                    </span> 
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                    ...
                                                    <!-- footer -->
                                                <tr>
                                                   <td width="100%" class="blk_container bmeHolder" name="bmePreFooter" valign="top" align="center" style="border: 0px none transparent; background-color: #FFF;">
                                                                  ...
                                                                  <td class="tblCellMain" style="padding: 20px 0px;">
                                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                        <tbody>
                                                                           ...
                                                                           <tr>
                                                                              <td align="center" class="bmeImage" style="border-collapse: collapse; padding: 10px;">
                                                                                    {{-- <img src="{{ asset('app/img/back_email.jpg') }}" alt="logoZoom" style="width: 100% !important;"> --}}
                                                                                    <h3 style="color: #5f5f5f;">Nosotros te notificaremos cuando tu pedido esté entregado</h3>
