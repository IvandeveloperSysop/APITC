                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td align="center" class="bmeImage" style="border-collapse: collapse; padding: 10px;">
                                                                        ...
                                                                        <h3 style="color: #a7a8a6;">{{$productName}},</h3>
                                                                        <br>
                                                                        <h2 style="margin-bottom: 0;">¡El producto se ha quedado  <b style="color: #E74C3C">sin Stock</b>!</h2>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                            </table>
                                                            ...
                                                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                ...
                                                                <tr>
                                                                    <td align="center" class="bmeImage" style="border-collapse: collapse; padding: 10px;">
                                                                        ...
                                                                        <h4 style="color: #a7a8a6;"> ¡Si usted desea aumentar el stock del producto, favor entrar la pagina de administacióny en el menú de Tienda > Productos!</h4>
